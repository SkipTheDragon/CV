 ...
 */
final class Version20200711144246 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD COLUMN cvlink VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__field');
        $this->addSql('CREATE INDEX IDX_5BF54558E2ABAFFF ON field (component_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__profile AS SELECT id, name, role, quotation, profile_img FROM profile');
        ...
        $this->addSql('INSERT INTO profile (id, name, role, quotation, profile_img) SELECT id, name, role, quotation, profile_img FROM __temp__profile');
